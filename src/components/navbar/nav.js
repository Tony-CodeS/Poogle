...
function nav() {
  return (
    ...
    <div className='nav'>
        ...
        <ul className='ul'>
            <li className='li'><a href='#Poogle' id='poogleLink'>poogle</a></li>
            <li className='li'> <a href='#Tokenomics' id='poogleLink'> Tokenomics</a></li>
            {/* <li className='li'> Audits</li> */}
            <li className='li' id='poogleLink'> FAQs</li>
            <li className='li' id='poogleLink'> FAQs</li>
        </ul>
    </div>
    {/* ending webnav */}
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="http" id='poogleLink'>POOGLE</a>
