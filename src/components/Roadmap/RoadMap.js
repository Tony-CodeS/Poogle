    ...
    <div>
        ...
        <div className='RoadMapList'>
                <div className='liDiv'>
                    ...
                    <li className='RoadMapLi' data-aos="fade-up"> Com-Building </li>
                    <li className='RoadMapLi' data-aos="fade-up"> Token sale </li>
                    <li className='RoadMapLi' data-aos="fade-up" > Exchange Listing</li>  
                    </ul>
                </div>
                <div className='liDiv'>
                    <ul>
                    ...
                    <li className='RoadMapLi' data-aos="fade-up"> Com-Expansion </li>
                    <li className='RoadMapLi' data-aos="fade-up">Marketing </li>
                    <li className='RoadMapLi' data-aos="fade-up">Governance </li>
                    </ul>
                </div>
                <div className='liDiv'>
                    <ul>
